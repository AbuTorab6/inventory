          ...
          <Accordion defaultActiveKey={`${isSidebarAccordionActive()}`}>
                {
                    ...
                    (
                        (item, index) => 
                        {
                                    ...
                                    <Accordion.Body>
                                        {
                                            ...
                                            (
                                                ...
                                                (
                                                    ...
                                                    <NavLink to={subItem.url} key={index.toString()} className={(navData) => navData.isActive ? 'side-bar-subitem-active side-bar-subitem ' : 'side-bar-subitem' } end>
                                                        {subItem.icon}
                            ...
                            : 
                            (
                            <NavLink to="/" className={(navData) => navData.isActive ? 'side-bar-item-active side-bar-item mt-2' : 'side-bar-item mt-2' } end>
                                {item.icon}
                                <span className="side-bar-item-caption"> {item.title} </span>
                            </NavLink>
                            );
